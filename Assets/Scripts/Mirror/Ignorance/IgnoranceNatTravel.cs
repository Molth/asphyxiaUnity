...
namespace IgnoranceTransport
{
    ...
    public class IgnoranceNatTravel : Transport, PortTransport
    {
        ...
        public override void ClientConnect(string address)
        {
            ...
            IsServer = false;
            Client.ServiceIPAddress = ServiceIPAddress;
            Client.ServicePort = ServicePort;
            // Start!
            Client.Start();
        }
        ...
        public override void ServerStart()
        {
            ...
            IsServer = true;
            Server.ServiceIPAddress = ServiceIPAddress;
        ...
        private void OnGUI()
        {
            if (IsServer && Server != null)
            {
                ...
                GUILayout.Label($"<b>Local</b>: {Server.LocalEndPoint}");
                GUILayout.EndArea();
            }
            else if (Client != null)
            {
                GUILayout.BeginArea(new Rect(10, 120, 300, 9999));
                GUILayout.Label($"<b>Local</b>: {Client.LocalEndPoint}");
                GUILayout.EndArea();
            }
